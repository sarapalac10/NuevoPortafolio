  ...
  return (
    <div className='cont-skills'>
        ...
        <div className='contenedor-skills'>
            ...
            <img src="https://res.cloudinary.com/dez9y1otk/image/upload/v1693965106/Portfolio/images_swa6o2.png" alt="The React Logo - React Js Logo Svg@nicepng.com" />                <figcaption>
                    <h2>React Js</h2>
