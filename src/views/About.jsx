      ...
      <div className='cont-about'>
        ...
        <div className='cont-perfil'>
          <h1>¿Quién soy?</h1>
            ...
            <p>Durante mi experiencia laboral, he tenido la oportunidad de trabajar en entornos altamente dinámicos y colaborativos. Así, adquirí una valiosa experiencia en el desarrollo web, centrándome en la creación de aplicaciones con React JS. Mi dedicación y habilidad en esta tecnología me permitieron contribuir de manera significativa a proyectos clave, mejorando la experiencia del usuario y colaborando en proyectos que impactan en miles de personas.</p>
